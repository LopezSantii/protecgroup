...
export default function Footer() {
  return (
    <footer className="container-fluid">
      ...
      <section className={`col-12 col-md-4 ${style.links}`}>
        <h4>Protecciones</h4>
        ...
        <Link className="nav-link" to="/category/soldadura">
          Soldadura
        </Link>
      ...
      <section className={`col-12 col-md-4 ${style.contacto}`}>
        <h3>Contacto</h3>
        ...
        <div className={style.contactIcons}>
          ...
          <p>administracion@protecgroup.com.ar</p>
        </div>
        <div className={style.contactIcons}>
          <Link
            style={{ padding: "0px", margin: "0px", textDecoration: "none" }}
            className={`mt-4 ${style.contactIcons}`}
            target="_blank"
            to="https://web.whatsapp.com/send?phone=1136598411&"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
